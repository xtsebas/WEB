(function($) {
  ...
  $("#btn-search-actors").click(function(){
		...
		$.ajax( {
			...
			type: "GET",
			url: '/seccion10-Grupo13/HelloServlet',
	...
	$("#btn-movie-insert").click(function(){
		...
		//alert("Resultado: " + '/seccion10-Grupo13/SaveMovieServlet?title=' + $('#txt-movie-title').val() + '&release_year=' + $('#txt-movie-release_year').val() + '&tagline=' + $('#txt-movie-tagline').val());
				
		$.ajax( {
			
			type: "GET",
			url: '/seccion10-Grupo13/SaveMovieServlet?title=' + $('#txt-movie-title').val() + '&release_year=' + $('#txt-movie-release_year').val() + '&tagline=' + $('#txt-movie-tagline').val() ,
			success: function(data) {
